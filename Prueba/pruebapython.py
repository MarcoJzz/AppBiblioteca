...
class TestUntitled():
  ...
  def test_untitled(self):
    ...
    self.driver.find_element(By.NAME, "correo").send_keys("pruebaincorrecta@gmail.com")
    self.driver.find_element(By.NAME, "clave").click()
    self.driver.find_element(By.NAME, "clave").send_keys("contraseña")
    ...
    self.driver.find_element(By.ID, "txtcorreo").send_keys("prueba1@gmail.com")
